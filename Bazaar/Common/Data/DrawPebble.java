...
// This class represents the player's choice to draw a pebble.
public class DrawPebble implements DrawPebbleOrExchanges {

  // attempts to draw a pebble from the given turn state's bank randomly and
  // returns the updated active player's wallet and bank if the valid, otherwise empty optional
  @Override
  public Optional<Pair<PebbleCollection, PebbleCollection>> attemptAction(Turn_State turnState, EquationTable equationTable) {
    if (turnState.bankPebbles().outOfPebbles()) {
      ...
      Pair<PebbleColor, PebbleCollection> randomPebbleAndNewBank = curBank.takeRandomPebble();
  ...
  public boolean equals(Object obj) {
    ...
    return obj instanceof DrawPebble;
  }
}
